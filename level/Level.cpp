...
Level::Level(char level_name[MAX_LEVEL_NAME_LENGTH], char level_string[MAX_LEVEL_CHARACTERS]) {
    int i;
...
void loadLevels(Level* levels) {
    ...
    while (level_index < level_count) {
        ...
        levels[level_index] = Level::Level(level_name, txt);
        level_index ++;
    }
